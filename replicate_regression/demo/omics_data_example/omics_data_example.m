...
% Note that the string 'replicate_regression_BASEDIR' points to the directory 'replicate_regression' 
% of your installation. You need to set this path by editing the m-file 'replicate_regression_BASEDIR'

% Directory name for the omics set
base_DIR      = [ replicate_regression_BASEDIR '/demo/omics_data_example/' ];
